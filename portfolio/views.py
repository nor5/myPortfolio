...
from .models import Skills, Education,WorkExperiences, Projects, Blogs
...
def mainPage(request):
    ...
    if request.method == "GET":
           form = ContactForm()
            ...
            if form.is_valid(): 
                ...
                message1 = "you got an e-mail from:\n" + name + "\n" + from_email + "\n" + message
                try:
    ...
    return  render (request, 'index.html', {'skills':skills, 'educations': educations,
'workExperiences': workExperiences ,   'projects': projects, 'blogs': blogs, "form": form })
...
def download_file(request):
      ...
      # fl_path = "/home/nour/Documents/nourPortfolio/portfolio/static/CV_2022-12-24_NourElhouda_Belkacem.pdf"
       filename = "static/CV_2023-02-16_Nour Elhouda_Belkacem.pdf"
